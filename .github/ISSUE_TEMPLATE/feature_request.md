...
about: Suggest a new feature or enhancement for the FastPix Go SDK
title: '[FEATURE] '
...
Thank you for suggesting a new feature for the FastPix Go SDK! Please provide the following information to help us understand and evaluate your request:
...
func main() {
    ...
    result, err := fastpix.YourNewFeature(ctx)
}
```
...
```
<!-- How do other Go SDKs handle this? -->
```
## Priority
