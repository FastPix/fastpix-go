...
* [ListUnusedUploadUrls](#listunuseduploadurls) - Get all unused upload URLs
...
func main() {
    ...
    res, err := s.ManageVideos.List(ctx, fastpixgo.Pointer[int64](20), fastpixgo.Pointer[int64](1), components.SortOrderDesc.ToPointer())
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    // your-upload-id: Upload ID returned from upload/create API
    res, err := s.ManageVideos.CancelUpload(ctx, "your-upload-id")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    // your-media-id: FastPix Media ID returned from upload/create API
    res, err := s.ManageVideos.UpdateTrack(ctx, "your-track-id", "your-media-id", components.UpdateTrackRequest{
...
<!-- UsageSnippet language="go" operationID="get-media-summary" method="get" path="/on-demand/{mediaId}/summary" -->
```go
package main
...
**[*operations.GetMediaSummaryResponse](../../models/operations/getmediasummaryresponse.md), error**
...
func main() {
    ...
    res, err := s.ManageVideos.ListUnusedUploadUrls(ctx, fastpixgo.Pointer[int64](20), fastpixgo.Pointer[int64](1), components.SortOrderDesc.ToPointer())
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
1. After the subtitle track is generated and ready, you receive the webhook event <a href="https://fastpix.com/docs/webhooks/transform-media-events#videomediasubtitlegeneratedready">video.media.subtitle.generated.ready</a>.
...
func main() {
    ...
    // your-media-id: FastPix Media ID returned from upload/create API
    // your-track-id: Track ID of the audio track to generate subtitles from
    res, err := s.ManageVideos.GenerateSubtitleTrack(ctx, "your-media-id", "your-track-id", components.TrackSubtitlesGenerateRequest{
...
<!-- UsageSnippet language="go" operationID="get-media-clips" method="get" path="/on-demand/{mediaId}/media-clips" -->
```go
package main
    ...
    if res.MediaClipResponse != nil {
        ...
        if res.HTTPMeta.Response != nil && res.HTTPMeta.Response.Body != nil {
            ...
            if err == nil && len(rawBody) > 0 {
                ...
                responseJSON, err := json.MarshalIndent(res.MediaClipResponse, "", "  ")
                if err != nil {
                    log.Printf("Error marshaling response: %v", err)
