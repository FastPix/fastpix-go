...
| Name                                           | Value                                          |
| ---------------------------------------------- | ---------------------------------------------- |
| `UpdatedMp4SupportMp4SupportNone`              | none                                           |
| `UpdatedMp4SupportMp4SupportCapped4k`          | capped_4k                                      |
| `UpdatedMp4SupportMp4SupportAudioOnly`         | audioOnly                                      |
| `UpdatedMp4SupportMp4SupportAudioOnlyCapped4k` | audioOnly,capped_4k                            |