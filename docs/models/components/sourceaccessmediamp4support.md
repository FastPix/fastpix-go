...
| Name                                           | Value                                          |
| ---------------------------------------------- | ---------------------------------------------- |
| `SourceAccessMediaMp4SupportNone`              | none                                           |
| `SourceAccessMediaMp4SupportCapped4k`          | capped_4k                                      |
| `SourceAccessMediaMp4SupportAudioOnly`         | audioOnly                                      |
| `SourceAccessMediaMp4SupportAudioOnlyCapped4k` | audioOnly,capped_4k                            |