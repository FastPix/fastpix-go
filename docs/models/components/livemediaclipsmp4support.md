...
| Name                                        | Value                                       |
| ------------------------------------------- | ------------------------------------------- |
| `LiveMediaClipsMp4SupportNone`              | none                                        |
| `LiveMediaClipsMp4SupportCapped4k`          | capped_4k                                   |
| `LiveMediaClipsMp4SupportAudioOnly`         | audioOnly                                   |
| `LiveMediaClipsMp4SupportAudioOnlyCapped4k` | audioOnly,capped_4k                         |