...
| Name                                             | Value                                            |
| ------------------------------------------------ | ------------------------------------------------ |
| `GetAllMediaResponseMp4SupportNone`              | none                                             |
| `GetAllMediaResponseMp4SupportCapped4k`          | capped_4k                                        |
| `GetAllMediaResponseMp4SupportAudioOnly`         | audioOnly                                        |
| `GetAllMediaResponseMp4SupportAudioOnlyCapped4k` | audioOnly,capped_4k                              |