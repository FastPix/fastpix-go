...
type PatchResponseData struct {
	...
	ReconnectWindow *int64 `json:"reconnectWindow,omitzero"`
...
func (p *PatchResponseData) GetEnableDvrMode() *bool {
	if p == nil {
		return nil
	}
	return p.EnableDvrMode
}
...
func (p *PatchResponseData) GetLowLatency() *bool {
	if p == nil {
		return nil
	}
	return p.LowLatency
...
func (p *PatchResponseData) GetClosedCaptions() *bool {
	if p == nil {
		return nil
	}
	return p.ClosedCaptions
}
