...
type ImposeTrack struct {
	...
	FadeInLevel *int64 `json:"fadeInLevel,omitzero"`
	// Level of fade-out effect (in seconds) at the end of the imposed audio.
	FadeOutLevel *int64 `json:"fadeOutLevel,omitzero"`
}
...
type AudioInput struct {
	...
	SwapTrackURL string `json:"swapTrackUrl"`
	// List of additional audio tracks to overlay on the video.
	ImposeTracks []ImposeTrack `json:"imposeTracks,omitzero"`
}
