...
type ListOverallValuesResponseBody struct {
	...
	Metadata *components.MetricsOverallmetadataDetails `json:"metadata,omitzero"`
	// Retrieves overall values for a specified metric
	Data *components.MetricsOverallDataDetails `json:"data,omitzero"`
	// The timespan from and to details displayed in the form of unix epoch timestamps.
	//
	Timespan []int64 `json:"timespan,omitzero"`
}

func (l ListOverallValuesResponseBody) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListOverallValuesResponseBody) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &l, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (l ListOverallValuesResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListOverallValuesResponse) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &l, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (l *ListOverallValuesResponse) GetDefaultError() *components.DefaultError {
	if l == nil {
		return nil
	}
