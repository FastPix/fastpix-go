...
func (g GetAllStreamsResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetAllStreamsResponse) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (g *GetAllStreamsResponse) GetDefaultError() *components.DefaultError {
	if g == nil {
		return nil
	}
