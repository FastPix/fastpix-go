...
func (d DisableLiveStreamResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DisableLiveStreamResponse) UnmarshalJSON(data []byte) error {
...
func (d *DisableLiveStreamResponse) GetDefaultError() *components.DefaultError {
	if d == nil {
		return nil
	}
