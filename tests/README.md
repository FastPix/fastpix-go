...
Last generated: 2026-06-02T09:23:38.594Z
...
|---|---|---:|---:|---|---|---|---|
| `/on-demand` | `list-media` | ❌ | ❌ | None | None | `data[].generatedSubtitles`, `data[].playbackIds[].accessRestrictions.domains.allow`, `data[].playbackIds[].accessRestrictions.domains.deny`, `data[].playbackIds[].accessRestrictions.userAgents.allow`, `data[].playbackIds[].accessRestrictions.userAgents.deny` | ❌ FAIL |
| `/on-demand/{livestreamId}/live-clips` | `list-live-clips` | ✅ | ❌ | None | None | `data` | ❌ FAIL |
| `/on-demand/{mediaId}` | `get-media` | ✅ | ❌ | None | None | `data.generatedSubtitles`, `data.playbackIds[].accessRestrictions.domains.allow`, `data.playbackIds[].accessRestrictions.domains.deny`, `data.playbackIds[].accessRestrictions.userAgents.allow`, `data.playbackIds[].accessRestrictions.userAgents.deny` | ❌ FAIL |
...
| `/on-demand/{mediaId}/playback-ids` | `list-playback-ids` | ✅ | ❌ | None | None | `data[].accessRestrictions.domains.allow`, `data[].accessRestrictions.domains.deny`, `data[].accessRestrictions.userAgents.allow`, `data[].accessRestrictions.userAgents.deny` | ❌ FAIL |
| `/on-demand/uploads` | `list-uploads` | ✅ | ❌ | None | None | `data` | ❌ FAIL |
| `/on-demand/{mediaId}/media-clips` | `get-media-clips` | ✅ | ❌ | None | None | `data` | ❌ FAIL |
| `/on-demand/playlists` | `get-all-playlists` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/on-demand/playlists/{playlistId}` | `get-playlist-by-id` | ✅ | ❌ | None | None | `data.mediaList` | ❌ FAIL |
| `/on-demand/{mediaId}/playback-ids/{playbackId}` | `get-playback-id` | ✅ | ❌ | None | None | `data.accessRestrictions.domains.allow`, `data.accessRestrictions.domains.deny`, `data.accessRestrictions.userAgents.allow`, `data.accessRestrictions.userAgents.deny` | ❌ FAIL |
...
| `/live/streams` | `get-all-streams` | ✅ | ❌ | None | None | `data` | ❌ FAIL |
...
| `/iam/signing-keys` | `list_signing_keys` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/iam/signing-keys/{signingKeyId}` | `get-signing_key_by_id` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/viewlist` | `list_video_views` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/viewlist/{viewId}` | `get_video_view_details` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/viewlist/top-content` | `list_by_top_content` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/dimensions` | `list_dimensions` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/dimensions/{dimensionsId}` | `list_filter_values_for_dimension` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/metrics/{metricId}/breakdown` | `list_breakdown_values` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/metrics/{metricId}/overall` | `list_overall_values` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/metrics/{metricId}/timeseries` | `get_timeseries_data` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/metrics/comparison` | `list_comparison_values` | ✅ | ❌ | None | None | None | ❌ FAIL |
| `/data/errors` | `list_errors` | ✅ | ❌ | None | None | None | ❌ FAIL |
...
- **list-media** (`/on-demand`)
  ...
  - **Empty arrays omitted by SDK**: `data[].generatedSubtitles`, `data[].playbackIds[].accessRestrictions.domains.allow`, `data[].playbackIds[].accessRestrictions.domains.deny`, `data[].playbackIds[].accessRestrictions.userAgents.allow`, `data[].playbackIds[].accessRestrictions.userAgents.deny`
...
- **list-playback-ids** (`/on-demand/{mediaId}/playback-ids`)
  - **Missing in SDK (present in API)**: None
  - **Missing in API (present in SDK)**: None
  - **Empty arrays omitted by SDK**: `data[].accessRestrictions.domains.allow`, `data[].accessRestrictions.domains.deny`, `data[].accessRestrictions.userAgents.allow`, `data[].accessRestrictions.userAgents.deny`
  - **Empty arrays omitted by API**: None
